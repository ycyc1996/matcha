...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var clientRouter, prefetch, location, route, AppCtrlClass, app;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                clientRouter = createRouter_1.default(_routes_1.default);
                prefetch = JSON.parse(decodeURIComponent(window.__PREFETCH__ || '{}'));
                location = JSON.parse(decodeURIComponent(window.__LOCATION__ || '{}'));
                route = clientRouter(location === null || location === void 0 ? void 0 : location.path);
                if (!route) return [3 /*break*/, 3];
                return [4 /*yield*/, getModuleAsync(route.loader)];
            case 1:
                AppCtrlClass = _a.sent();
                return [4 /*yield*/, createApp_1.default(AppCtrlClass, {
                        isServer: false,
                        isClient: true,
                        location: __assign({}, location),
                        prefetch: __assign({}, prefetch)
                    })];
            case 2:
                app = _a.sent();
                if (app.getCtrl().ssr) {
